...
var Service = function Service() {
    ...
    this.getByInviteCode = _regenerator2.default.mark(function _callee(inviteCode) {var 
        res;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return this.findOne({ invitecode: inviteCode });case 2:res = _context.sent;return _context.abrupt('return', 
